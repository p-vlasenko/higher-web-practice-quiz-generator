...
export class ErrorBrowserView implements Renderer<ErrorDescription> {
    ...
    constructor(element: HTMLElement) {
        ...
        this.#messageElement = getFirstElementOrFail('.toast__title', element);
        this.#detailsElement = getFirstElementOrFail('.toast__message', element);
        this.#hideButton = getFirstElementOrFail('.toast__action', element) as HTMLButtonElement;
